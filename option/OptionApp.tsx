...
const FRAMEWORKS: FrameworkOption[] = [
  { id: 'javas', name: 'Selenium Java', subtitle: 'Standard Java WebDriver actions', icon: '☕', accent: '24, 95%, 52%' },
  { id: 'playwrightJS', name: 'Playwright (Node)', subtitle: 'Modern JS/TS test framework', icon: '🎭', accent: '168, 100%, 40%' },
  { id: 'playwrightJava', name: 'Playwright (Java)', subtitle: 'Java bindings for Playwright API', icon: '🚀', accent: '200, 100%, 50%' },
  { id: 'py', name: 'Selenium Python', subtitle: 'Python bindings for Selenium', icon: '🐍', accent: '45, 100%, 48%' },
  { id: 'csharp', name: 'Selenium C#', subtitle: 'C# .NET driver actions', icon: '🎯', accent: '265, 100%, 65%' },
  { id: 'protractorjs', name: 'Protractor (Angular)', subtitle: 'Angular E2E automation library', icon: '🛡️', accent: '350, 100%, 60%' },
  { id: 'cypress', name: 'Cypress', subtitle: 'Developer-friendly web test runner', icon: '🌲', accent: '160, 100%, 40%' },
  { id: 'custom', name: 'Custom Framework', subtitle: 'Define your own POM structures', icon: '🛠️', accent: '38, 92%, 50%' }
];

const OptionApp: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'general' | 'selectors' | 'templates' | 'about'>('general');
        ...
        <div style={styles.sidebar}>
          ...
          <div style={styles.navGroup}>
            <button 
              ...
              style={{
                ...styles.sidebarLink,
                backgroundColor: activeTab === 'general' ? 'rgba(79, 70, 229, 0.12)' : 'transparent',
            ...
            <button 
              ...
              style={{
                ...styles.sidebarLink,
                backgroundColor: activeTab === 'selectors' ? 'rgba(79, 70, 229, 0.12)' : 'transparent',
                color: activeTab === 'selectors' ? '#38bdf8' : '#8b949e',
                borderLeft: activeTab === 'selectors' ? '4px solid #4f46e5' : '4px solid transparent'
              }}
            >
            ...
            <button 
              ...
              style={{
                ...styles.sidebarLink,
                backgroundColor: activeTab === 'templates' ? 'rgba(79, 70, 229, 0.12)' : 'transparent',
                color: activeTab === 'templates' ? '#38bdf8' : '#8b949e',
                borderLeft: activeTab === 'templates' ? '4px solid #4f46e5' : '4px solid transparent'
              }}
            >
        ...
        <div style={styles.mainPanel}>
          ...
          {activeTab === 'general' && (
            <div style={styles.tabContent}>
              <div style={styles.sectionHeader}>
                ...
                <p style={styles.mainSubtitle}>Choose the default test automation framework generated when copying locators.</p>
              </div>
                ...
                {FRAMEWORKS.map((f) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {isActive && (
                        <div style={styles.cardActiveCheck}>
                          ✓
                        </div>
                      )}
                    </div>
              ...
              <div style={styles.previewContainer}>
                <div style={styles.previewHeader}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ fontSize: '11px', textTransform: 'uppercase', letterSpacing: '1px', fontWeight: 'bold', color: '#8b949e' }}>
          ...
          {activeTab === 'selectors' && (
            <div style={styles.tabContent}>
              <div style={styles.sectionHeader}>
                ...
                <p style={styles.mainSubtitle}>Define the order in which HTML attributes are queried to find unique web elements.</p>
              </div>

              <div style={styles.card}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
                  <h3 style={{ margin: 0, fontSize: '15px', color: '#ffffff' }}>Priority Order List</h3>
                ...
                {!rawTextMode ? (
                  <>
                    ...
                    <div style={styles.priorityPillContainer}>
                      {tagList.map((tag, idx) => (
                        ...
                        >
                          <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                            <span style={{ fontSize: '11px', color: '#8b949e', fontWeight: 'bold' }}>{idx + 1}</span>
                            <span style={{ color: '#ffffff', fontWeight: '500' }}>{tag}</span>
                          </div>
                          
                          <div style={{ display: 'flex', gap: '2px', borderLeft: '1px solid #30363d', paddingLeft: '8px', marginLeft: '4px' }}>
                            <button 
                  ...
                  <div>
                    <label style={{ display: 'block', color: '#8b949e', fontSize: '13px', marginBottom: '8px' }}>
                    ...
                    <div style={{ color: '#8b949e', fontSize: '12px', marginTop: '8px' }}>
                      Recommended: <code style={{ color: '#58a6ff' }}>data-testid, data-cy, id, name, class</code>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div style={styles.infoCard}>
                <div style={{ fontSize: '15px', fontWeight: 'bold', color: '#ffffff', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {activeTab === 'templates' && (
            <div style={styles.tabContent}>
              <div style={styles.sectionHeader}>
                ...
                <p style={styles.mainSubtitle}>Configure dynamic structural templates to match your internal framework design patterns.</p>
              </div>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '20px' }}>
                ...
                <div style={styles.card}>
                  <form onSubmit={handleSaveAll} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    <div>
                      <label style={{ display: 'block', fontSize: '13px', fontWeight: '600', color: '#8b949e', marginBottom: '8px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  ...
                  <div style={styles.card}>
                    <h3 style={{ margin: '0 0 4px 0', fontSize: '15px', color: '#ffffff' }}>Playground Compiler</h3>
                    <p style={{ margin: '0 0 16px 0', fontSize: '12px', color: '#8b949e' }}>
                      Mock Element: <code style={{ color: '#58a6ff' }}>button#login-btn</code>, locator: <code style={{ color: '#58a6ff' }}>"//button[@id='login']"</code>
                    </p>
                            ...
                            <code>
                              {colorizeCode(
                                compileTemplate(
                                  clickvalue, 
                                  'loginBtn', 
                                  customLang === 'jscs' ? `element(by.id('login'))` : `By.xpath("//button[@id='login']")`, 
                                  'LoginBtn'
                                ), 
                  ...
                  <div style={styles.card}>
                    <h3 style={{ margin: '0 0 12px 0', fontSize: '15px', color: '#ffffff' }}>Available Variables</h3>
          ...
          {activeTab === 'about' && (
            <div style={styles.tabContent}>
              ...
              <div style={styles.card}>
                <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginBottom: '24px', paddingBottom: '20px', borderBottom: '1px solid #21262d' }}>
                  <div style={{
                    width: '64px',
                    height: '64px',
                    borderRadius: '16px',
                ...
                <h3 style={{ color: '#ffffff', fontSize: '16px', margin: '0 0 10px 0' }}>Core Features</h3>
                <ul style={{ color: '#c9d1d9', fontSize: '13.5px', lineHeight: '1.8', margin: '0 0 24px 0', paddingLeft: '20px' }}>
                ...
                <h3 style={{ color: '#ffffff', fontSize: '16px', margin: '0 0 12px 0' }}>Useful Links</h3>
